...
function noise() {
  ...
  var noise2 = new THREE.DataTexture(
    data,
    width,
    width,
    THREE.RedFormat,
  ...
  noise2.wrapS = THREE.MirroredRepeatWrapping;
  noise2.wrapT = THREE.MirroredRepeatWrapping;
  noise2.magFilter = THREE.LinearFilter;
  noise2.minFilter = THREE.LinearMipMapLinearFilter;
