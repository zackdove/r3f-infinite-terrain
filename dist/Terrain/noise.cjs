...
function noise() {
  ...
  var noise2 = new THREE__namespace.DataTexture(
    data,
    width,
    width,
  ...
  noise2.wrapS = THREE__namespace.MirroredRepeatWrapping;
  noise2.wrapT = THREE__namespace.MirroredRepeatWrapping;
  noise2.magFilter = THREE__namespace.LinearFilter;
  noise2.minFilter = THREE__namespace.LinearMipMapLinearFilter;
  noise2.generateMipmaps = true;
